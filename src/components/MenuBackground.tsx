...
const MenuBackground: React.FC = () => {
  ...
  const baseColor = isTracklinePage ? '#1a0505' : '#0a0514';
  const gradientColor = isTracklinePage ? '#2e0b0b' : '#1a0b2e';
  ...
  useEffect(() => {
    ...
    const waves = [
      new Wave(30, 0.003, 0, isTracklinePage ? 'rgba(139, 51, 51, 0.1)' : 'rgba(88, 51, 139, 0.1)'),
      new Wave(25, 0.004, 1, isTracklinePage ? 'rgba(117, 52, 52, 0.1)' : 'rgba(72, 52, 117, 0.1)'),
      new Wave(20, 0.005, 2, isTracklinePage ? 'rgba(95, 53, 53, 0.1)' : 'rgba(58, 53, 95, 0.1)'),
      new Wave(15, 0.006, 3, isTracklinePage ? 'rgba(73, 54, 54, 0.1)' : 'rgba(44, 54, 73, 0.1)')
    ];
